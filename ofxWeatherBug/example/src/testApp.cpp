...
void testApp::setup(){
    ...
    // load font sets
    med.load("eurofurence/eurof55.ttf", 24);
    light.load("eurofurence/eurof35.ttf", 24);
    smallLight.load("eurofurence/eurof55.ttf", 14);
}
...
void testApp::draw(){
    ...
    DATA.conditionIMG.draw(265, 35, DATA.conditionIMG.getWidth()*1.5, DATA.conditionIMG.getHeight()*1.5 );
    ...
    DATA.moonPhaseIMG.draw(280, 430, DATA.moonPhaseIMG.getWidth()*2, DATA.moonPhaseIMG.getHeight()*2);
